      ...
      <CornerDotsBox>
        <Background>
          ...
          <T color="gray12" size="6">
            ...
            I have ~4 years of experience working in the wind engineering industry as a Software Developer, where I built <b>dashboards</b>, <b>charts</b> and <b>performant interfaces</b> coupled with unique designs and animations.
            <br />
            <br />
            What you are looking at is an over-engineered Next.js/React/TypeScript app with an FUI-inspired design system.
